...
extern "C" {
	...
	const char* net_guard_module() {
		return NETGUARD_COMMAND_INPUT_MODULE_IDENT;
	}
	...
	NetGuard_Command_Input_Module *create_command_input_module() {
		return new NetGuard_Command_Input_Example();
	}

	void destroy_command_input_module(NetGuard_Command_Input_Module *p) {
		delete p;
	}
