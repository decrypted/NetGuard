...
#ifndef NETGUARD_INPUT_RING_MODULE
#define NETGUARD_INPUT_RING_MODULE
...
extern "C" {
	...
	NetGuard_Input_Module* create_input_module();
	void destroy_input_module(NetGuard_Input_Module* p);
